                    ...
                    <div class="login-form">
                        ...
                        <form class="form" id="kt_login_singin_form" action="">
                            ...
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Auth Number</label>
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                    type="text" name="auth_number" id="auth_number" autocomplete="off"
                                    placeholder="auth number" value="0000000"/>
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    <label
                                        class="font-size-h6 font-weight-bolder text-dark pt-5">{{ __('cms.password') }}</label>
                                ...
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                    ...
                                    placeholder="{{ __('cms.password') }}" autocomplete="off" value="password"/>
                            </div>
                            <div class="row">

                                <!--end::Form group-->
                                <div class="checkbox-inline col-8">
                                ...
                                <div class="checkbox-inline col-4">
                                    @if ($guard === 'doctor')
                                        <a href="{{ route('cms.doctor.register') }}">Regiester</a>
                                    @endif

                                    @if ($guard === 'user')
                                        <a href="{{ route('cms.user.register') }}">Regiester</a>
                                    @endif
                                </div>
                            </div>
                            <!--begin::Action-->
