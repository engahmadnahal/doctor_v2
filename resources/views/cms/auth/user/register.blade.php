...
<head>
    <!-- <base href="../../../../"> -->
    <meta charset="utf-8" />
    <title> Regiester | {{ __('cms.app_name') }}</title>
...
<body id="kt_body"
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" id="kt_login_singin_form" action="">
                            ...
                            <div class="form-group row">
                                <label class="font-size-h6 font-weight-bolder text-dark">Doctors</label>

                                <div class=" col-lg-6 col-md-9 col-sm-12">
                                    <select
                                        class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 select2"
                                        id="doctors" name="param" multiple="multiple">


                                        @foreach ($specialties as $s)
                                            <optgroup label="{{ $s->name }}">
                                                @foreach ($s->doctors as $doctor)
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                    type="file" name="files[]" id="files" multiple autocomplete="off"
                                    placeholder="files" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
    ...
    <script>
        ...
        var certificate = new KTImageInput('certificate_1');

        function register() {
            let formData = new FormData();

            let doctors = Array.from(document.getElementById('doctors').selectedOptions)
                .forEach(option => formData.append('doctors[]', option.value) );
            ...
            fileArray = Array.from(document.getElementById('files').files);
            fileArray.forEach(file => formData.append('files[]', file));

            store('/cms/user/register', formData, '/cms/user/register/success-register');
        }
    </script>
    <!--end::Page Scripts-->
</body>
