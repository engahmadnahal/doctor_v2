                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                        type="text" name="address" id="address" autocomplete="off"
                                        placeholder="address" />
                                </div>
                                <!--end::Form group-->
                                <!--begin::Form group-->
                                ...
                                <div class="form-group row mt-4 col-12">
                                    <label class="col-3 col-form-label">Specialty :<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div class="dropdown bootstrap-select form-control dropup">
                                            <select class="form-control selectpicker" data-size="7" id="specialty_id"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        <label class="col-12 col-form-label">Certificate:</label>
                                        <div class="col-9">
                                            <div class="image-input image-input-empty image-input-outline"
                                                ...
                                                <label
                                                    ...
                                                    data-original-title="Change avatar">
                                                    <i class="fa fa-pen icon-sm text-muted"></i>
                                                    <input type="file" name="image" id="certificate"
                                                        accept=" .pdf">
                                                    <input type="hidden" name="image">
                                                </label>
                                            ...
                                            <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-12">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{ $d->name }}"
                                                                id="name_{{ $d->id }}" autocomplete="off"
                                                                placeholder="Name" />
                                                        </div>
                                                        <!--end::Form group-->
                                                        <!--begin::Form group-->
                                                        ...
                                                        <div class="form-group col-12">
                                                            <label
                                                                class="font-size-h6 font-weight-bolder text-dark">Address</label>
                                                            <input
                                                                class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                                                type="text" name="address_{{ $d->id }}"
                                                                value="{{ $d->address }}"
                                                                id="address_{{ $d->id }}" autocomplete="off"
                                                                placeholder="address" />
                                                        </div>
                                                        <!--end::Form group-->
                                                        <!--begin::Form group-->
                                                            ...
                                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                                <div class="dropdown bootstrap-select form-control dropup">
                                                                    <select class="form-control selectpicker"
                                                                        data-size="7"
                                                                        id="specialty_id_{{ $d->id }}"
                                                                        title="Choose one of the following..."
                                                                        tabindex="null" data-live-search="true">
                                                                        @foreach ($specialties as $s)
                                                                            <option value="{{ $s->id }}"
                                                                                @selected($d->specialty_id == $s->id)>
                                                                                {{ $s->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-6">
                                                                ...
                                                                <div class="col-9">
                                                                    <div class="image-input image-input-empty image-input-outline"
                                                                        id="certificate_1_{{ $d->id }}"
                                                                        style="background-image: url({{ \Storage::url($d->certificate) }})">
                                                                        <div class="image-input-wrapper"></div>
                                                                ...
                                                                <a href="{{ \Storage::url($d->certificate) }}">File</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary font-weight-bold"
                                                        data-dismiss="modal" onclick="update({{$d->id}})">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        @foreach ($data as $d)
            ...
            var certificate{{ $d->id }} = new KTImageInput('certificate_1_{{ $d->id }}');
        @endforeach
        ...
        function save() {
            ...
            store("{{ route('doctor.admin.store') }}", formData, "{{ route('doctor.admin.index') }}");
        }
        ...
        function update(id) {
            ...
            formData.append('specialty_id', document.getElementById('specialty_id_' + id).value);
            formData.append('avater', document.getElementById('avater_' + id).files ? document.getElementById('avater_' + id).files[0] : '');
            formData.append('certificate', document.getElementById('certificate_' + id).files ? document.getElementById('certificate_' + id).files[0] : '')

            store("/cms/admin/doctor/" + id, formData, "{{ route('doctor.admin.index') }}");
        }

        function deleteDoctor(id, el) {

            confirmDestroy("/cms/admin/doctor/", id, el);
        }
    </script>
@endsection
