    ...
    <div class="row">
        <div class="col-xl-3">
            ...
            <a class="card card-custom bg-light-primary bg-hover-state-light-primary card-stretch gutter-b">
                ...
                <div class="card-body">
                    <span
                        class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Add-user.svg--><svg
        ...
        <div class="col-xl-3">
            ...
            <a class="card card-custom bg-light-primary bg-hover-state-light-primary card-stretch gutter-b">
                ...
                <div class="card-body">
                    <span
                        class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Timer.svg--><svg
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
