...
<body id="kt_body"
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" id="kt_login_singin_form" action="">
                            ...
                            <div class="pb-5 pb-lg-15">
                                <h3 class="font-weight-bolder text-dark font-size-h3 font-size-h4-lg">
                                    Check your mail for get auth data .</h3>
                            </div>

                            <div class="pb-lg-0 pb-5">
                                <a href= "{{ route('cms.login','doctor') }}" id="kt_login_singin_form_submit_button"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Go
                                    Login</a>
                            </div>
                            <!--end::Action-->
                        </form>
    ...
    <script>
        ...
        function register() {
            ...
            store('/cms/doctor/register', formData);
        }
    </script>
    <!--end::Page Scripts-->
</body>
